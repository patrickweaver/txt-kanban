...
This is a local first web app that creates a kanban board from a .txt file. The .txt file is kept in source control with the project that is being worked on. In this repo, as an example, we have `cranban.md`.
